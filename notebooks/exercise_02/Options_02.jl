...
begin
	xx = [P Pδ;C Cδ]
	with_terminal() do
		printmat(xx,rowNames=["put","call"],colNames=["no dividends","δ=$δ"],width=15)
	end
end

# ╔═╡ 548142dc-c591-40a4-a7cf-00b36ca7ac15
md"""
### Plot call option price for different strike prices
"""
...
# ╔═╡ 63340e6b-529c-4e6f-b07f-0918a191eab1
md"""
### Plot call option price for different stock prices
"""
